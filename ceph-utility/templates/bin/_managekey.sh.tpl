...
# As of now all commands executed inside utility container are being logged in /var/log.
# We need to change the logging.Formatter to include UserName and also remove
