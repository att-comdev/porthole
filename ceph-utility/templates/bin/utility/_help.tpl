...
echo " nccli rados --pool <poolname> mksnap <snap-name>"
echo " nccli rados --pool <poolname> get"
echo " nccli rados --help"
echo " nccli rados --pool <poolname> lssnap"
echo " nccli rados --pool <poolname> mksnap <snapname>"
echo " nccli rados --pool <poolname> get object2"
echo " nccli rados --pool <poolname> listattr FO"
echo " nccli rados --pool <poolname> getxattr obj attr"
echo " nccli rados --pool <poolname> stat object2"
echo " nccli rados --pool <poolname> stat2 object2"
echo " nccli rados --pool <poolname> listomapkeys object2"
echo " nccli rados --pool <poolname> listomapvals object2"
