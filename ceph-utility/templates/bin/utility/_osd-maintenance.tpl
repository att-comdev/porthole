...
usage() {
  set +ex
  echo "Usage:  nccli osd-maintenance.sh osd_remove"
  echo "        nccli osd-maintenance.sh osd_add"
  echo "        nccli osd-maintenance.sh check_osd_status"
  echo "        nccli osd-maintenance.sh reweight_osds"
  echo "        nccli osd-maintenance.sh remove_osd_by_id --osd-id <OSDID>"
  exit 1
}
