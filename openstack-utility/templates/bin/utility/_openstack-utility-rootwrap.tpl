...
elif {{ .Values.conf.utility.promptForUsername | quote }} == 'true':
    user_id = getpass.getuser()
else:
    print("User environment not configured properly, please follow" 
            "the steps as mentioned on wiki to execute commands on a utility container")
    exit()
